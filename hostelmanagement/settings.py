...
SECRET_KEY = 'django-insecure-jlpna@%fs$ydl!4q=&6^c#a$^fw-#463@i9^eg&(t3l0unxhti'
...
LOGIN_REDIRECT_URL = '/hostel/index/'  # Redirect after login
LOGOUT_REDIRECT_URL = '/hostel/login/'  # Redirect after logout
